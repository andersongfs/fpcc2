...
fit <- kmeans(ppg_scaled[3:9], centers = 3, nstart = 20) # 3 cluster solution
# get cluster means 
...
teste <- melt(ppg_scaled, id = c(".row", "fit.cluster") )
...
```{r}
ppg.pca <- prcomp(ppg_scaled[1:7],center = TRUE) 
print(ppg.pca)
plot(ppg.pca, type = "l")
